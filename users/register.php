<?php  
	...
	if ($_POST) {
		...
		if (!empty($errors)) {
			...
			$db->query("INSERT INTO user (full_name, phone_number, bvn, email, password, account_number, account_name) 
				VALUES ('$name', '$phone_number', '$bvn', '$email', '$hashed_password', '$account_number', '$account_name')");
